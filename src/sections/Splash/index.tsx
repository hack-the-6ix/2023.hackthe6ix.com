  ...
  return (
    ...
    >
      <Typography
        ...
        as='p'
      >
        <Highlight highlightColor='shades-0'>
          {startFormat.format(startDate)} - {endFormat.format(endDate)} • In-person
          event
        </Highlight>
      </Typography>
      <Typography
        ...
        textColor='shades-0'
        // change to same heading/font-size as below
        textType='heading1'
        as='h1'
      >
      ...
      >
        ...
        <VCarousel className={cx(carousel, highlight)} items={words} />
      </Typography>
      {/* Email Sign up */}
      <Socials
        className={socials}
